                        ...
                        @foreach($autosSugeridos as $s)
                            <div class="similar-card"
                                ...
                                <div class="similar-card-body">
                                    ...
                                    {{-- Precio Mensual (Calculado a 60 meses como referencia) --}}
                                    <div class="similar-price">
                                        ${{ number_format($s->precio / 60, 0) }}
                                        <small>MXN/mes</small>
                                    </div>

                                    {{-- Precio de Contado --}}
                                    <div class="similar-contado">
                                        ${{ number_format($s->precio, 0) }} MXN de contado
                                    </div>

                                    {{-- Etiqueta de mercado (Opcional) --}}
                                    <div class="similar-market">
                                        <i class="bi bi-graph-down-arrow"></i> Precio competitivo
                                    </div>
                                </div>
                            </div>
                        @endforeach
